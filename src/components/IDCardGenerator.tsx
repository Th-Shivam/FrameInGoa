      ...
      <AnimatePresence mode="wait">
        ...
        {step === 'preview' && cardDataUrl && (
          <motion.div
            ...
            className="flex flex-col lg:flex-row items-center lg:items-center justify-center gap-16 min-h-[80vh] max-w-6xl mx-auto"
          >
            {/* Left — info + buttons */}
            <div className="flex flex-col gap-8 w-full max-w-lg">
              <div>
                <p className="font-mono text-sm uppercase tracking-[0.4em] text-[#98E8A3] mb-4">
                  — Your Card is Ready —
                </p>
                <h2
                  className="text-5xl md:text-6xl font-bold text-[#f5efe4] leading-tight"
                  style={{ fontFamily: 'var(--font-display)', letterSpacing: '-0.02em' }}
                >
                  Generate Your{' '}
                  <span
                ...
                <p className="text-[#b3c7aa] mt-4 text-lg">
                  Your Hacker ID:{' '}
                  <span className="font-mono text-[#FFE600] font-bold text-xl">{hackerId}</span>
                </p>
                <p className="text-[#6b8f6b] mt-2 text-sm">
                  Welcome to Hacker House Goa 2026. Your identity is forged. 🔥
                </p>
              </div>
              ...
              <div className="flex flex-col gap-4 w-full">
                <button
                  ...
                  className="w-full flex items-center justify-center gap-3 py-5 rounded-2xl font-bold text-lg text-white transition-all active:scale-[0.98] shadow-xl"
                  style={{ background: 'linear-gradient(135deg, #FF007F 0%, #e0006e 100%)', boxShadow: '0 8px 32px rgba(255,0,127,0.4)' }}
                >
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" strokeWidth={2.5} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M4 16v2a2 2 0 002 2h12a2 2 0 002-2v-2M7 10l5 5 5-5M12 15V3" /></svg>
                  Download ID Card
                </button>
                ...
                <div className="flex gap-3">
                  <button
                    ...
                    className="flex-1 flex items-center justify-center gap-2 py-4 rounded-2xl font-semibold text-sm text-white transition-all hover:opacity-90 active:scale-[0.98]"
                ...
                <button
                  onClick={handleReset}
                  className="w-full flex items-center justify-center gap-2 py-4 rounded-2xl border-2 border-[#FFE600]/30 text-[#b3c7aa] text-base font-medium hover:bg-white/5 hover:border-[#FFE600]/60 transition-all"
                >
            ...
            <div className="relative flex-shrink-0">
              <div
                className="absolute inset-0 rounded-3xl blur-3xl opacity-50 scale-110"
                style={{ background: 'radial-gradient(circle, #FF007F 0%, #FFE600 60%, transparent 80%)' }}
              />
              <img
                src={cardDataUrl}
                alt="Your Hacker House Goa ID Card"
                className="relative rounded-3xl shadow-2xl border-2 border-[#FFE600]/30"
                style={{ imageRendering: 'crisp-edges', width: '380px', maxWidth: '90vw' }}
              />
            </div>
          </motion.div>
        )}
